...
for filename in os.listdir(os.getcwd()):
    if filename.endswith(".ncs") and filename.startswith("CSC"): 
        ...
        datapoints5khz = lynxio.fileSplitterUsingEvents(csc, eventTimestamps[15],
                								 eventNames[15], eventTimestamps[16], eventNames[16])[0:229888]
        datapoints9khz = lynxio.fileSplitterUsingEvents(csc, eventTimestamps[17],
                								 eventNames[17], eventTimestamps[18], eventNames[18])[0:229888]    
        #datapoints15khz = lynxio.fileSplitterUsingEvents(csc, eventTimestamps[19],
