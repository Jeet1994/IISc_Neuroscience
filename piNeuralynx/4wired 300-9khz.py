...
maxdata = [datapoints100hz,datapoints250hz,datapoints300hz, datapoints450hz, datapoints500hz,datapoints600hz,datapoints750hz,datapoints1khz,datapoints2khz, 
           datapoints4khz, datapoints6khz, datapoints7khz, datapoints8khz, datapoints9khz]#, datapoints10khz, datapoints12khz]
...
plt.title('300hz - 9khz Box plots')
plt.show(plotname)
