# -*- coding: utf-8 -*-
"""
Created on Wed Apr 06 14:15:12 2016
...
for filename in os.listdir(os.getcwd()):
    if filename.endswith(".ncs") and filename.startswith("CSC"): 
        ...
        datapoints600hz = fileSplitter.fileSplitterUsingEvents(csc, eventTimestamps[31],
        ...
        data = [fft(datapoints250hz),fft(datapoints300hz), fft(datapoints450hz), fft(datapoints500hz),fft(datapoints600hz),fft(datapoints750hz),fft(datapoints1khz),fft(datapoints2khz), 
                   fft(datapoints4khz), fft(datapoints6khz), fft(datapoints7khz), fft(datapoints8khz), fft(datapoints9khz), fft(datapoints10khz)]
