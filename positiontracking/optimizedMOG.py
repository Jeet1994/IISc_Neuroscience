...
Detected motion events are logged to a text file.
"""
...
class Target:
	...
	def run(self):
		...
		while True:
			...
			# because the camera clips us to 30 fps.  But if reading from a file,
			...
			if not self.writer:
				...
				if delta_t < ( 1.0 / 30.0 ): time.sleep( ( 1.0 / 30.0 ) - delta_t )
