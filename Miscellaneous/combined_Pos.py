...
for line in camera1PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera1Position.append(line)

for line in camera2PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera2Position.append(line)

for line in camera3PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera3Position.append(line)

for line in camera4PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera4Position.append(line)

for line in camera5PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera5Position.append(line)
    
for line in camera6PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera6Position.append(line)

for line in camera7PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera7Position.append(line)

for line in camera8PosData:
    line = line.rstrip('\n')
    line = eval(line)
    camera8Position.append(line)
